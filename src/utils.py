...
def collect_user_details(request_header):
    ...
    refresh_freq = input('How often do you want to refresh the calendar (in seconds)? Default 5. Minimum 3. : ')
    refresh_freq = int(refresh_freq) if refresh_freq and int(refresh_freq) >= 3 else 5
